...
export default function Sidebar({ usuario, isOpen = false, onClose }: SidebarProps) {
  ...
  const menuItems = [
    ...
    { icon: PlusCircle, label: 'Crear Producto', href: '/dashboard/crear-producto', adminOnly: false }, // ← Siempre visible
    { icon: Tag, label: 'Crear Tipo', href: '/dashboard/crear-tipo', adminOnly: false }, // ← Siempre visible
    ...
    <div className="flex flex-col h-full bg-white border-r border-gray-200">
      <div className="flex items-center justify-between p-6 border-b border-gray-200">
        <Link href="/dashboard" className="flex items-center space-x-2" onClick={onClose}>
          <span className="text-2xl font-bold text-primary-600">VentasYesStyle</span>
